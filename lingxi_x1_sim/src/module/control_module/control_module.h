...
class ControlModule : public aimrt::ModuleBase {
 ...
 private:
  ...
  void ImuDataCallback(const std::shared_ptr<const aimrt::protocols::sensor::ImuState>& msg);
 ...
 private:
  ...
  aimrt::context::res::Subscriber<aimrt::protocols::sensor::ImuState> imu_data_sub_;
